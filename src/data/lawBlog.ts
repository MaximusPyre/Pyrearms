...
export const LAW_BLOG: LawBlogPost[] = [
	{
		id: "2026-08-20-frame-receiver",
		date: "August 20, 2026",
		title: "N.D. Texas enjoins ATF frame/receiver rule for Defense Distributed and SAF members",
		body: "On August 17, 2026, Chief Judge Reed O’Connor (N.D. Texas, Fort Worth) issued an opinion in VanDerStok / Defense Distributed v. Blanche, No. 4:22-cv-00691-O. Final judgment (Dkt. 331) was entered August 18, 2026; it contains no stay. After Bondi v. VanDerStok, 604 U.S. 458 (2025), only Defense Distributed and the Second Amendment Foundation remained. The court granted the government summary judgment on the remaining APA counts, so this is not a nationwide vacatur of the 2022 Final Rule and does not disturb Bondi’s holding that the GCA can reach at least some unfinished frames and kits. On Counts Five and Six the court declared 27 C.F.R. §§ 478.11 and 478.12(c) unconstitutional under the Second Amendment and void for vagueness under the Fifth Amendment, and that those provisions “cannot be enforced against Defense Distributed, SAF, or any of SAF’s current or future members.” The permanent injunction is narrower: ATF/DOJ are barred from enforcing those two sections against those same parties “with respect to Defense Distributed’s M1911 80% Frames and G80 Build Kit, Unfinished Receiver, and Grip Module.” The 2026 judgment does not name Defense Distributed customers as a covered class (unlike an earlier 2023 preliminary injunction). It is not a repeal of unfinished-frame rules for the general public. State serialization, possession, and 3D-print bans still apply. Ordinary GCA Form 4473 / background-check rules can still apply to completed firearms. DOJ can still appeal. Primary PDFs: opinion Dkt. 330 and judgment Dkt. 331 on RECAP. Separately, the Federal Register on August 20 published a DOJ/ATF final rule on applications for relief from federal firearms disabilities (91 FR 54054), effective September 21, 2026 — not a PMF or NFA-registration rule. No new federal PMF public law: GovInfo still has only introduced texts for H.R. 8059, H.R. 4143, S. 2165, and S. 4339. Silencer Shop Foundation v. ATF still shows no notice of appeal (last filing Aug. 14 counsel withdrawal). Brown v. ATF remains under submission after the Aug. 10 argument (last docket item Aug. 12 transcript). Official codes and session-law pages re-checked for restricted jurisdictions still match the map; Minnesota SF 3661 remains at Senate second reading; Michigan SB 331 is still in House Government Operations. Education, not legal advice.",
		changed: ["Federal PMF / unfinished frames (party-specific injunction)"],
	},
	{
