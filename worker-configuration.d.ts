/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b09b9f3862b0f4f7cae8decb611cf437)
// Runtime types generated with workerd@1.20260804.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	PUBLIC_APP_NAME: "PyreArms";
	ADMIN_PASSWORD: string;
	SESSION_SECRET: string;
	PUBLIC_APP_URL: string;
	STRIPE_SECRET_KEY: string;
	STRIPE_WEBHOOK_SECRET: string;
	CONNECT_ORACLE_ID: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_APP_NAME" | "ADMIN_PASSWORD" | "SESSION_SECRET" | "PUBLIC_APP_URL" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "CONNECT_ORACLE_ID">> {}
}
